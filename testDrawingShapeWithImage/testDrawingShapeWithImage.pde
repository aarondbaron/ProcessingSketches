...
created by Aaron Albin
 ...
 each new shape has to remember where it got the image from...
 assume we start with rectangle shape ... 
...
void setup()
{
  ...
  //img = loadImage("rock.png"); // using texture rock is not a permanent solution..you will see in game the rock shift
  //imageLoc = new PVector(width/2, height/2);
  origWidth=img.width;
  origHeight=img.height;
  imageMode(CENTER);

  lineStart=new PVector(0, 40);
